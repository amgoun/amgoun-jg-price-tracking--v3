          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  className="bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent)_/_80%,_black)] text-white px-6 sm:px-8 lg:px-12 py-4 sm:py-5 lg:py-6 text-base sm:text-lg rounded-full font-semibold transition-all duration-300 hover:scale-105"
                >
                  {cta.buttonText}
                </Button>
