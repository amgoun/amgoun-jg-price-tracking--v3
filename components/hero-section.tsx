      ...
      <div className="container mx-auto px-6 lg:px-12 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 lg:gap-16 gap-8 items-center">
          ...
          <div className="max-w-2xl">
            ...
            >
              <Button size="lg" className="bg-bluewish hover:bg-bluewish/70 text-blacker  rounded-full">
            ...
            >
              ...
              <span className="text-white/90">
                Rated {data.rating.score} <span className="font-normal">{data.rating.text}</span>
              </span>
            </motion.div>
          </div>
          ...
          >
            <div className="relative flex items-center justify-center">
                ...
                <div className="absolute bg-[radial-gradient(ellipse_200%_100%_at_center,theme(colors.bluewish)_0%,theme(colors.bluewish)_100%)] blur-3xl h-full w-full top-0 z-10 opacity-20"></div>
              <motion.div
                animate={{
                  y: [0, -10, 0],
                }}
